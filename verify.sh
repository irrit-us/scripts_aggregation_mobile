...
check_file "tests/ScriptManagerTest.kt" "Script manager tests"
check_file "tests/SignatureVerifierTest.kt" "Signature verifier tests"
check_file "tests/ScriptExecutionTest.kt" "Script execution tests"
echo ""
